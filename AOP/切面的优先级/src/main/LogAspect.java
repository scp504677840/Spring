...
public class LogAspect {
     ...
     * @param result    返回值
     */
    @AfterReturning(value = "execution(public double main.ArithmeticCalculator.divide(double ,double ))", returning = "result")
     ...
     * @param e         异常
     */
    @AfterThrowing(value = "execution(public double main.ArithmeticCalculator.divide(double ,double ))", throwing = "e")
     ...
     */
    /*@Around("execution(public double main.ArithmeticCalculator.divide(double ,double ))")
